export const Icons = {
  ...
  discordFooter: {
    paths: [
      {
        d: "M24.457 2.08A21.014 21.014 0 0018.546 0c-.25.437-.538 1.01-.735 1.463a19.697 19.697 0 00-5.889 0A14.597 14.597 0 0011.194 0 20.945 20.945 0 003.543 2.08C.647 6.646-.228 11.076.14 15.451A20.749 20.749 0 006.285 20a15.411 15.411 0 001.23-2.006 13.217 13.217 0 01-1.948-.929c.163-.119.326-.25.478-.384 3.774 1.756 7.88 1.756 11.616 0 .163.134.326.266.489.384-.62.372-1.27.7-1.948.974.37.7.774 1.366 1.211 2.006a20.682 20.682 0 006.145-4.549c.537-5.416-.9-9.814-3.604-13.37zM9.81 13.757c-1.105 0-2.016-1.004-2.016-2.238 0-1.233.894-2.238 2.016-2.238 1.122 0 2.026 1.017 2.016 2.238 0 1.234-.894 2.238-2.016 2.238zm8.38 0c-1.105 0-2.016-1.004-2.016-2.238 0-1.233.894-2.238 2.016-2.238 1.122 0 2.026 1.017 2.016 2.238 0 1.234-.894 2.238-2.016 2.238z",
      },
    ],
    class:
      "h-4 w-4 flex-shrink-0 fill-current text-neutral-700 dark:text-neutral-400",
